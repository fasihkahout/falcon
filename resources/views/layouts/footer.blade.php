...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/js/bootstrap.bundle.min.js"
    ...
    <script>
        (function () {
            var js = "window['__CF$cv$params']={r:'8090ba7d4a27f621',t:'MTY5NTExNDk3Mi4yMzYwMDA='};_cpo=document.createElement('script');_cpo.nonce='',_cpo.src='/cdn-cgi/challenge-platform/scripts/jsd/main.js',document.getElementsByTagName('head')[0].appendChild(_cpo);";
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#oneway_btn').click(function(e){
                e.preventDefault();
                $('#onewayform').show();
                $('#roundwayform').hide();
            })

            $('#returnway_btn').click(function(e){
                e.preventDefault();
                $('#onewayform').hide();
                $('#roundwayform').show();
