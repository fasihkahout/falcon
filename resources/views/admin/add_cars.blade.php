    ...
    <div class="card-body">
            ...
            <form action="{{ route('postcars') }}" method="POST" class="register-form" id="car-form" novalidate enctype="multipart/form-data">
                ...
                <div class="img" style="text-align: center;">
                                        ...
                                        <label><img id="blah" src="@if(isset($img)){{asset($img);}}@else {{asset('assets/img/idnex-1-747x597.png')}} @endif" alt="your image" style=" border-radius: 50% ;width: 100px; height: 100px" />
                ...
                <div class="mb-1">
                  <label class="login-label d-flex flex-md-row justify-content-between" for="name">Car Name</label>
                    <input class="signin-input col-md-12" id="name" type="text" placeholder="..." name="name"  value="{{ old('name') }}">
                    
                </div>

                <div class="mb-1">
                  <label class="login-label d-flex flex-md-row justify-content-between" for="model">Car Model</label>
                    <input class="signin-input col-md-12" id="model" type="text" placeholder="..." name="model"  value="{{ old('model') }}">
                ...
                <div class="mb-1">
                   <label class="login-label d-flex flex-md-row justify-content-between" for="seats">Car Seats</label>
                    <input class="signin-input col-md-12" id="seats" type="text" placeholder="..." name="seats"  value="{{ old('seats') }}">
                   
                </div>

                <div class="mb-1">
                  <label class="login-label d-flex flex-md-row justify-content-between" for="ac">AC or Non AC</label>
                    <input class="signin-input col-md-12" id="ac" type="text" placeholder="..." name="ac"  value="{{ old('ac') }}">
                    
                </div>
               
                 <div class="mb-1">
                  <label class="login-label d-flex flex-md-row justify-content-between" for="ac">First Mile Price</label>
                    <input class="signin-input col-md-12" id="first_mile_price" type="text" placeholder="..." name="first_mile_price"  value="{{ old('first_mile_price') }}">
                    
                </div>
                <div class="mb-3">
                  <label class="login-label d-flex flex-md-row justify-content-between" for="ac">After First Mile Price</label>
                    <input class="signin-input col-md-12" id="after_first_mile_price" type="text" placeholder="..." name="after_first_mile_price"  value="{{ old('after_first_mile_price') }}">
