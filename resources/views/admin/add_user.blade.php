...
@include('admin.navbar')
 ...
 <h1 class="card-title" style="position: relative;right: 0%; color:black;" >Add User</h1>
</div>
    ...
    <form action="{{ route('postusers') }}" method="POST" class="register-form" id="car-form" novalidate enctype="multipart/form-data">
            ...
            <input type="text" name="name" class="signin-input col-md-12" value="{{ old('name') }}" placeholder="" >
            
        </div>
       
            <div class="mb-1">
            <label for="exampleFormControlInput1" class="form-label" style="display: block;">E-mail</label>
            <input type="text" name="email" class="signin-input col-md-12" value="{{ old('email') }}" placeholder="" >
            </div>
