@include('admin.sidebar')
        ...
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
                <p class="text-sm mb-0 text-capitalize">Total Car Catgeories</p>
  ...
  <div class="card z-index-2 ">
    ...
    <div class="card-body">
      ...
      <p class="text-sm">7 Days Performance</p>
      <hr class="dark horizontal">
      <div>
        @if($analyticsData->isNotEmpty())
          <p class="mb-0 text-sm">Date: {{ $analyticsData[0]['date']->toDateString() }}</p>
          <p class="mb-0 text-sm">Active Users: {{ $analyticsData[0]['activeUsers'] }}</p>
          <p class="mb-0 text-sm">Screen Page Views: {{ $analyticsData[0]['screenPageViews'] }}</p>
        @else
          <p class="mb-0 text-sm">No analytics data available</p>
        @endif
                </div>
              </div>
            </div>
        ...
        <div class="col-lg-12 col-md-6 mb-md-0 mb-4">
          <div class="card">
            <div class="card-header pb-0">
             <h3 class="card-title" style=" color:black;" >Bookings</h3>
            </div>
