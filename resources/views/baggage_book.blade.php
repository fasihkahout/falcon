                                ...
                                <div class="row g-4 align-items-center">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <ul class="list-group list-group-borderless mt-2 mb-0">
                                            ...
                                            <!-- <li class="list-group-item d-flex pb-0 mb-0">
                                                <span class="h6 fw-normal mb-0"><i class="fa fa-check me-2"></i>Passenger Luggage : {{ $baggages->first()->luggage }} </span>
                                            </li> -->
                                            <li class="list-group-item d-flex pb-0 mb-0">
...
@endforeach
                                ...
                                <!-- Button -->
                                <a href="{{ route('baggageconfirmbooking', ['car_id' => $car->id]) }}" class="btn btn-dark mb-0 mt-2">Pay Now</a>
                            </div>
                        </div>
                    </div> 
                </aside>
