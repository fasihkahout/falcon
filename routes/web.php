...
Route::get('/addblogs', [AdminController::class, 'addblogs'])->name('addblogs');
Route::post('/postblogs', [AdminController::class, 'postblogs'])->name('postblogs');
Route::get('/editblogs/{id}', [AdminController::class, 'editblogs'])->name('editblogs');
Route::post('/updateblogs/{id}', [AdminController::class, 'updateblogs'])->name('updateblogs');
...
Route::get('/deleteblogs/{id}', [AdminController::class, 'deleteblogs'])->name('deleteblogs');
//Categories
